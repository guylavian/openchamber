...
export const dict: Record<I18nKey, string> = {
  ...
  'workspace.move.left': 'Mover para a esquerda',
  'workspace.move.center': 'Mover para o centro',
  'workspace.move.right': 'Mover para a direita',
  'workspace.move.bottom': 'Mover para baixo',
  'workspace.move.newWindow': 'Abrir em nova janela',
  'workspace.zone.collapse': 'Recolher zona',
  'workspace.zone.label.left': 'Zona esquerda',
  'workspace.zone.label.center': 'Zona central',
  'workspace.zone.label.right': 'Zona direita',
  'workspace.zone.label.bottom': 'Zona inferior',
  'workspace.zone.resize.left': 'Redimensionar a zona esquerda',
  'workspace.zone.resize.bottom': 'Redimensionar a zona inferior',
  'workspace.preset.title': 'Layout',
  'workspace.preset.default': 'Padrão',
  'workspace.preset.developer': 'Desenvolvedor',
  'workspace.preset.codeAgent': 'Código + agente',
  'workspace.preset.reset': 'Redefinir layout',
};
